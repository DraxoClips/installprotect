    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by: 
                <span class="label label-primary">@DraxoClips</span>
                <span class="label label-success">@testidraxoreal2/span>
                <span class="label label-info">DraxoClips</span>
            </p>
        </div>
        @else
...
sed -i "s|DraxoClips|${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|@DraxoClips|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|@DraxoClipsl|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
    ...
    ">
        ...
        ">
            ...
            <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                <span style="background: #e84393; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@DraxoClips</span>
                <span style="background: #0984e3; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@testidraxoreal2</span>
                <span style="background: #00b894; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@DraxoClipstech</span>
            </div>
        </div>
