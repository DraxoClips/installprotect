    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                <span class="label label-success">@DraxoClips</span>
                <span class="label label-info">@testidraxoreal2</span>
            </p>
        </div>
        @else
...
sed -i "s|@DraxoClips|${CONTACT_TELEGRAM}|g" "$INDEX_FILE" 2>/dev/null || true
sed -i "s|Protected by: DraxoClips|Protected by: ${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
    ...
    <div class="security-container">
        ...
        <div class="security-content">
            ...
            <div class="team-badges">
                <span class="team-badge" style="background: #fd79a8;">@DraxoClips</span>
                <span class="team-badge" style="background: #74b9ff;">Jhoanley Tech</span>
                <span class="team-badge" style="background: #55efc4;">@DraxoClips</span>
            </div>
